# Scripts
A collection of simple scripts I have created to carry out various tasks and to help me learn shell scripting. Created for, and tested using, Arch and Void GNU/Linux distributions using Bash 5.1.8. I would imagine it highly likely that these scripts contain bugs.  
